...
import { listRules, listSources, listTemplates } from "@/lib/db/quality-automation";
...
export default async function AutomationRulesPage() {
  ...
  const [rules, templates, sources, positions] = await Promise.all([
    ...
    <div className="max-w-6xl space-y-6">
      <header className="space-y-2">
        ...
        <p className="text-sm text-ink-soft">
          Una regla dice qué observar, con qué condición y qué hacer cuando se cumple.
          Nada más: emite señales, avisa a un cargo y crea tareas.
        </p>
      </header>
