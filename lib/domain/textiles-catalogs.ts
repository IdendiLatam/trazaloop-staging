...
export const TEXTILE_FIBER_BASE_CATALOG_EXPLANATION =
  ...
  "para todas las empresas. No pueden modificarse ni eliminarse. Si necesitas una " +
  "fibra que no aparece aquí, registra una fibra personalizada de tu empresa.";

export const TEXTILE_FIBER_CUSTOM_SECTION_TITLE = "Fibras personalizadas de tu empresa";

export const TEXTILE_FIBER_CUSTOM_EXPLANATION =
  "Las fibras personalizadas solo son visibles y utilizables por tu empresa. Pueden " +
