...
export const qualityActionList: ExportDefinition = {
  ...
  entity: "Acciones",
  recordType: "Acciones",
  documentName: "Listado de acciones",
  kind: "list",
  permission: "member",
...
export const qualityControlList: ExportDefinition = {
  ...
  documentName: "Listado de controles",
  kind: "list",
  permission: "member",
  orientation: "portrait",
  temporality: "current",
...
export const qualityRiskAssessmentDetail: ExportDefinition = {
  ...
  documentName: "Evaluación de riesgo",
  kind: "historical",
  permission: "member",
  orientation: "portrait",
  temporality: "historical",
...
export const qualityPeriodClosureList: ExportDefinition = {
  ...
  documentName: "Listado de cierres de periodo",
  kind: "list",
  permission: "member",
  orientation: "portrait",
  temporality: "historical",
