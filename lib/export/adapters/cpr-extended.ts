...
export const cprProductDetail: ExportDefinition = {
  ...
  entity: "Producto",
  recordType: "Producto",
  documentName: "Ficha de producto",
  kind: "detail",
  permission: "member",
...
export const cprMaterialDetail: ExportDefinition = {
  ...
  entity: "Material",
  recordType: "Material",
  documentName: "Ficha de material",
  kind: "detail",
  permission: "member",
  orientation: "portrait",
  temporality: "current",
...
export const cprCustomerRequirementList: ExportDefinition = {
  ...
  documentName: "Listado de requisitos de cliente",
  kind: "list",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprRecycledContentDetail: ExportDefinition = {
  ...
  documentName: "Contenido reciclado",
  kind: "detail",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprRecycledContentList: ExportDefinition = {
  ...
  recordType: "Contenido reciclado",
  documentName: "Reporte de contenido reciclado",
  kind: "list",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprSupportCalculationDetail: ExportDefinition = {
  ...
  documentName: "Cálculo de soporte",
  kind: "detail",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprEvidenceMatrixDetail: ExportDefinition = {
  ...
  documentName: "Matriz de evidencias",
  kind: "detail",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprDossierDetail: ExportDefinition = {
  ...
  documentName: "Expediente de auditoría",
  kind: "historical",
  permission: "member",
  orientation: "landscape",
...
export const cprDossierList: ExportDefinition = {
  ...
  documentName: "Listado de expedientes de auditoría",
  kind: "list",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprExerciseDetail: ExportDefinition = {
  ...
  documentName: "Ejercicio de trazabilidad",
  kind: "historical",
  permission: "member",
  orientation: "landscape",
  temporality: "historical",
...
export const cprExerciseList: ExportDefinition = {
  ...
  documentName: "Listado de ejercicios de trazabilidad",
  kind: "list",
  permission: "member",
  orientation: "landscape",
  temporality: "current",
...
export const cprDiagnosticDetail: ExportDefinition = {
  ...
  documentName: "Diagnóstico de preparación",
  kind: "detail",
  permission: "member",
  orientation: "portrait",
  temporality: "current",
