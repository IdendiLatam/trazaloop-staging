...
Trazaloop solicita en cada petición que el proveedor **no almacene** el
contenido en sus repositorios de la interfaz de programación. Esa solicitud
**no equivale** a un acuerdo de retención cero: son cosas distintas y esta
política no las confunde.

> **PENDIENTE DE CONFIRMACIÓN HUMANA — no publicar sin resolver:**
> el proveedor concreto contratado para el entorno de producción, el ajuste
> de la cuenta respecto del uso de datos para entrenamiento, y la existencia
> o no de acuerdos de retención cero o de exclusión de revisión humana.
> Ver `PE_02B5A_HUMAN_CONFIRMATIONS.md`.
...
contenido almacenado por él. Lo que se declara es lo que consta en su
documentación oficial, con la fecha en que se consultó.
