...
**Fecha de entrada en vigor:** la de su publicación en la plataforma (§ 21)
...
| Proveedor | Categoría de servicio | Cuándo interviene |
|---|---|---|
| **Supabase** | Autenticación, base de datos y almacenamiento | Siempre |
| **Vercel** | Alojamiento y entrega de la aplicación web | Siempre |
| **Proveedor de inteligencia artificial contratado por la Corporación** | Generación de respuestas de Trazaloop Intelligence, únicamente sobre el contexto que el servidor selecciona para cada consulta (§ 18) | **Solo** cuando la empresa tiene habilitado Trazaloop Intelligence y alguien lo usa |
...
automática**: ocurre en el momento de cada consulta a Trazaloop Intelligence,
en las empresas que tienen la función habilitada. Donde la función no está
habilitada, o no se usa, **no se envía nada a ese proveedor**. La Corporación
no anuncia como tratamiento en curso el que solo ocurre al usar la función.
...
- **Versión comercial:** 1.1.
- **Sucede a:** la versión 1.0, aprobada el 27 de julio de 2026.
- **Fecha de entrada en vigor:** la de su publicación en la plataforma. La
  plataforma la registra al publicar la versión y la muestra junto al
  documento, y esa misma fecha queda en la constancia de cada aceptación.
- **Versión anterior:** se archiva con su fecha de retiro y se conserva
  accesible, porque hay personas que aceptaron ese texto y no este.
